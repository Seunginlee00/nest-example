      ...
      return new Promise((resolve, reject) => {
        ...
        client.value.on('message', (topic, payload, packet) => {
          try {
            ...
            if (
              ...
              typeof finalOptions.onMessage === 'function'
            ) {
              try {
        ...
        client.value.on('close', () => {
          ...
          if (
            ...
            typeof finalOptions.onDisconnect === 'function'
          ) {
            try {
              finalOptions.onDisconnect();
            } catch (callbackError) {
        ...
        client.value.on('error', (error) => {
          ...
          if (
            ...
            typeof finalOptions.onError === 'function'
          ) {
            try {
